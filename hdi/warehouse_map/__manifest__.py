# -*- coding: utf-8 -*-
{
    ...
    'assets': {
        'web.assets_backend': [
            ...
            'warehouse_map/static/src/css/warehouse_map_3d.css',
            'warehouse_map/static/src/js/warehouse_map_view.js',
            'warehouse_map/static/src/js/warehouse_map_3d_view.js',
            'warehouse_map/static/src/xml/warehouse_map.xml',
            'warehouse_map/static/src/xml/warehouse_map_3d.xml',
        ],
    },
    'installable': True,
    'application': True,
