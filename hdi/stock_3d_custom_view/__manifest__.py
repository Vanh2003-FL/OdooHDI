# -*- coding: utf-8 -*-
{
    ...
    'version': '18.0.1.0.0',
    'category': 'Warehouse',
    'summary': """Virtual 3D Visualization of warehouses and Locations - Integrated with Warehouse Map""",
    'description': """This module innovative addition to the inventory and 
     ...
     Integrated with warehouse_map module to display actual product/lot positions in 3D.""",
    'author': 'Cloud Open Technologies/K8 Team - Upgraded to Odoo 18 by Wokwy',
    'depends': ['stock', 'web', 'warehouse_map'],
    'data': [
    ...
    'assets': {
        'web.assets_backend': [
            ...
            # New integrated 3D view with warehouse_map
