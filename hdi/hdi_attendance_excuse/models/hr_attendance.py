...
class HRAttendance(models.Model):
    ...
    check_in_location = fields.Text(
        string="Check In Address Detail",
        readonly=True
    )

    check_out_location = fields.Text(
        string="Check Out Address Detail",
        readonly=True
    )
    ...
    @api.model
    def api_check_in(self, employee_id, in_latitude=None, in_longitude=None, check_in_location=None):
        ...
        # Thêm check_in_location nếu có
        if check_in_location:
            attendance_data['check_in_location'] = check_in_location
        ...
        return {
            ...
            'check_in_location': attendance.check_in_location or '',
            'in_latitude': attendance.in_latitude,
            'in_longitude': attendance.in_longitude,
        }

    @api.model
    def api_check_out(self, employee_id, out_latitude=None, out_longitude=None, check_out_location=None):
        ...
        # Thêm check_out_location nếu có
        if check_out_location:
            update_data['check_out_location'] = check_out_location
        ...
        return {
            ...
            'check_out_location': attendance.check_out_location or '',
            'in_latitude': attendance.in_latitude,
            'in_longitude': attendance.in_longitude,
